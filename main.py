...
footerall="discord.gg/unbanning | developed by wyse"
import discord
import fade
import requests
...
prefix= "!"
token="MTIxOTgzMTQwMzg3Nzg5MjE2Nw.G8ywyw.wYZ6HBp9PG_BPOLI4PoPFIEncmo9jkhdOnbTgQ"
version ="1.0"
ownerid="sJlI5OM413"
sellerkey="dde747596cb4e8add24baefa6846658d"
logsgen="1219069539120058438"
blacklistlogs="1219069539120058438"
disclogs="1219069539120058438"
downloadnoxius="link_here"
deletekeyslogs="1219069539120058438"
redeemlogs="1219069539120058438"
logsdownloads="1219069539120058438"
iconsurl="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=b91a2e9337e99e23baae92ff&"
resethwidlogs="1219069539120058438"
...
async def on_ready():
    os.system("clear")
    print(faded_gui)
    await bot.change_presence(status=discord.Status.online,activity=discord.Game(f" discord.gg/unbanning"))
@bot.group(invoke_without_command=True)
async def help(ctx):
    embed= discord.Embed(title="***EvoAuth help***", description="- *List of helps*", colour=0x0001)
    embed.add_field(name="*EvoAuth General Help*", value=f"```{prefix}help general```")
    embed.add_field(name="*EvoAuth Staffs Help*", value=f"```{prefix}help staff```")
    embed.add_field(name="*EvoAuth Help*", value=f"```{prefix}help auth```")
    embed.set_footer(text=f"{ctx.author.name} | {footerall}", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_author(name="EvoAuth", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    await ctx.reply(embed=embed)
@help.command()
async def general(ctx):
    embed= discord.Embed(title="*EvoAuth General Help*", description="- *List of general commands*", colour=0x0001)
    ...
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_footer(text=f"{ctx.author.name} | {footerall}", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_author(name="Evovled Software", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    await ctx.reply(embed=embed)
    await ctx.message.delete()

@help.command()
async def staff(ctx):
    embed=discord.Embed(title="*EvoAuth Help*", description="- *List of all commands of Staffs*", colour=0x0001)
...
@help.command()
async def auth(ctx):
    embed=discord.Embed(title="*EvoAuth Help*", description=f"*List of all commands of Auth*", colour=0x00001)
    embed.set_author(name="EvoAuth", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_footer(text=f"{ctx.author.name} | {footerall}", icon_url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=9681484a957513f24ff871e29aa10d4896dc7e6eb91a2e9337e99e23baae92ff&")
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1219837176942952468/1219844794235228221/evovled_logo.png?ex=660cc7fe&is=65fa52fe&hm=b91a2e9337e99e23baae92ff&")
...
async def on_command_error(ctx,error):
  if isinstance(error, commands.CommandNotFound):
    await ctx.reply(embed=discord.Embed(title="*EvoAuth Invalid Command*",description=f"{ctx.author.name}, Invalid command, you can do `!help` for all commands!",colour=0xff0000))
  if isinstance(error, commands.MissingRequiredArgument):
    await ctx.reply(embed=discord.Embed(title="*EvoAuth Missing Arguments*",description=f"{ctx.author.name}, Command Missing Argument!",colour=0x00000))
...
async def kick(ctx, member: discord.Member, *, reason=None):
  try:
    ...
    embed=discord.Embed(title="*EvoAuth | User kicked sucesfully*",description=f"{member}, Has been Kicked from {ctx.guild.name}.\nReason is `{reason}`. This Kick was requested from\n{ctx.author.mention}",colour=0x00000)
...
async def ban(ctx, member: discord.Member, *, reason=None):
  try:
    ...
    embed=discord.Embed(title="*EvoAuth | User banned sucesfully*",description=f"{member}, Has been banned from **{ctx.guild.name}**.\n This ban was requested from\n{ctx.author.mention}",colour=0x00000)
    embed.add_field(name="*Expiration:*", value=f"```Permantly```", inline=True)
...
async def cooldown(ctx, seconds:int):
  ...
  await ctx.send(embed=discord.Embed(title="EvoAuth | Cooldown Specificated",description=f"*SlowMode Is {seconds} in {ctx.channel.mention}+",colour=0x00000))
  logs_channel = bot.get_channel(int(disclogs))
...
async def unban(ctx, username,*, reason=None):
  ...
  embed=discord.Embed(title="*EvoAuth | User unbanned sucesfully*",description=f"*{user}, Has been Unbanned from Evovled Software \n Reason is `{reason}`. This Unban was requested from*\n{ctx.author.mention}",colour=0x00000)
...
@bot.command()
async def ping(ctx):
  await ctx.reply(embed=discord.Embed(title="*:ping_pong: EvoAuth Pong!*",description=f"*The bot latency is {round(bot.latency * 1000)}ms*",colour=0x00000))
...
async def botinfo(ctx):
  ...
  embed=discord.Embed(title="**EvoAuth Information**",colour=0x00000)
  embed.add_field(name="*Bot Status:*", value=f"<a:yesverify:1030494749804744765> Working | {version}", inline=True)
  embed.add_field(name="*Developer*", value=f"```wyse```", inline=True)
  await ctx.reply(embed=embed)	
@bot.command()
@commands.has_permissions(manage_messages=True)
async def warn(ctx, member: discord.Member, *, reason=None):
  try:
    embed=discord.Embed(title="*EvoAuth: User was warned sucesfully*",description=f"{member.mention}, has been warned from {ctx.author.mention} Reason is ``{reason}``.\nThis warn was requested from {ctx.author.mention}",colour=0x00000)
    embed.add_field(name="**Expiration:**", value=f"``Permantly``", inline=True)
...
async def redeem(ctx,lic):
  ...
  try:
    ...
    if req.json()["success"] == True:
      ...
      await logs_channel.send(embed=discord.Embed(title="Evovled Software Key Redeem", description=f"```Key: {lic} | Redeemed by {ctx.author}```", colour=0x000001))
      await ctx.message.delete()
    else:
...
async def resethwid(ctx,user):
  ...
  if req.json()["success"] == True:
    await ctx.reply(embed=discord.Embed(title="*Reset Completed!*",description=f"HWID Reset For User `{user}`",colour=0x00000))
    logs_channel = bot.get_channel(int(resethwidlogs))
    await logs_channel.send(embed=discord.Embed(title="*Hwid Reset Completed!*",description=f"{ctx.author.mention}, Used Reset command for `{user}`",colour=0x00000))
  else:
...
async def banaccount(ctx,user,*,reason=None):
  ...
  if req.json()["success"] == True:
    embed=discord.Embed(title="**Evolved Software: User was Banned**",description=f"{user}, Has been banned from {ctx.guild.name} .\nReason is `{reason}`. This ban was requested from\n{ctx.author.mention}",colour=0x00000)
    embed.add_field(name="Expiration:", value=f"``Permantly``", inline=True)
    embed.add_field(name="Banned By:", value=f"``{ctx.author}``", inline=True)
    await ctx.reply(embed=embed)
  else:
...
async def unbanaccount(ctx,user):
  ...
  if req.json()["success"] == True:	
    embed=discord.Embed(title="**Evolved Software: User was unbanned**",description=f"{user}, Has been unbanned from {ctx.guild.name}.\n",colour=0x00000)
    embed.add_field(name="Unbanned By:", value=f"``{ctx.author}``", inline=True)
    await ctx.reply(embed=embed)
  else:
...
async def deletelicense(ctx,lic):
  ...
  if req.json()["success"] == True:
    ...
    await logs_channel.send(embed=discord.Embed(title="EvoAuth License Deleted!",description=f'Succesfully Deleted License ({lic}) by {ctx.author.mention}',colour=0x00001))
  else:
...
async def genkey(ctx,day:int):
  ...
  global keyssss
  req = requests.get(f"https://keyauth.win/api/seller/?sellerkey={sellerkey}&type=add&expiry={day}&mask=******-******-******-******-******&level=1&amount=1&format=json")
  if req.json()["success"] == True:
    key = req.json()["key"]
    keyssss[key] = day
    embed1=discord.Embed(title="**EvoAuth Key Generated**",description=f"```{key}```",colour=0x00001)
    embed1.set_author(name="EvoAuth", icon_url=iconsurl)
    ...
    embed.set_author(name="EvoAuth" ,icon_url=iconsurl)
...
async def prices(ctx):
  embed=discord.Embed(title="***EvoAuth Prices" , description="- *1 Week Key* | **$10**\n- *1 Day Key* | **$5**\n- *1 Month Key* | **$15**\n - *Lifetime Key* | **$20**\n **__Reseller Plan__**\n - *Buy 4 Keys of 50%*\n **__Infinite Gen Keys__ **\n - *Infinite gen HWID SPOOFER Keys* | **$60**\n *No limits or cooldowns*", colour=0x00000)
  embed.set_author(name="Evolved Software", icon_url=iconsurl)
  embed.set_footer(text=footerall, icon_url=iconsurl)
  embed.set_thumbnail(url=iconsurl)
  await ctx.reply(embed=embed)
  await ctx.message.delete()
...
async def status(ctx):
  embed=discord.Embed(title="***https://discord.com/channels/1206309461820444763/1219837176942952468/1219837695841271868 Status***", description="\n *HWID Spoofer* | **Working**\n *Fortnite Private* | **Working**", colour=0x00001)
  embed.set_author(name="Evolved Software",icon_url=iconsurl)
  embed.set_footer(text=footerall, icon_url=iconsurl)
  embed.set_thumbnail(url=iconsurl)
  await ctx.reply(embed=embed)
...
async def download(ctx):
  ...
  if role not in ctx.author.roles:
    ...
    embed=discord.Embed(title="*Evovled Download*", description=f"{downloadnoxius}", colour=0x000001)
    embed.set_author(name="EvoAuth", icon_url=iconsurl)
    embed.set_footer(text=footerall, icon_url=iconsurl)
    embed.set_thumbnail(url=iconsurl)
    await ctx.author.send(embed=embed)
    logsgen2=bot.get_channel(int(logsdownloads))
    await ctx.reply(embed=discord.Embed(title="Evolved download <:Caixa:1034575086738485289> ", description=f"Check your DM", colour=0x00001))
    await ctx.message.delete()
    await logsgen2.send(embed=discord.Embed(title="Evolved download <:Caixa:1034575086738485289> ", description=f"{ctx.author.mention} <:arrow:1034476786056175688>  download", colour=0x00001))
bot.run(token)